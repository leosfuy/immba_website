(() => {
  ...
  const i18n = {
    zh: {
      ...
      "downloads.title": "表格下載",
      "downloads.desc": "維持「表格下載」入口，但以更現代的卡片式呈現。",
      "downloads.item1": "申請表（示意）",
      "downloads.item2": "修課規劃表（示意）",
      "downloads.item3": "離校流程（示意）",
    ...
    en: {
      ...
      "downloads.desc": "Same entry point, now presented in modern cards.",
      "downloads.item1": "Application form (sample)",
      "downloads.item2": "Study plan (sample)",
      "downloads.item3": "Graduation checklist (sample)",
